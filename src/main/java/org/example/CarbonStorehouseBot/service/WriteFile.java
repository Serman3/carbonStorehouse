...
public class WriteFile {
    ...
    protected void writeExcelFileExample(List<Object[]> fabricAndMetricData, List<Roll> rollList, String messageText){
    ...
    protected void writeExcelFileAllReadyFabric(Map<List<Object[]>, List<Roll>> allDataFabric, String messageText){
